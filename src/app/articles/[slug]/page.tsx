...
const allArticles = [
    ...
    },
    {
      ...
      content: "<p>Our annual Summer Youth Program has come to a successful end, culminating in a fantastic showcase event where participants presented their projects. This year's program focused on digital literacy and creative arts, providing a platform for young people to develop new skills and express their creativity. The projects ranged from short films to interactive websites, all demonstrating the incredible talent and hard work of our youth.</p><p>We are incredibly proud of all the participants and grateful to our mentors and sponsors for making this program possible.</p>"
    },
    {
      image: "https://placehold.co/600x400.png",
      date: "July 20, 2024",
      ...
      content: "<p>The sun was shining on our Community Garden Harvest Day, where volunteers and community members came together to reap the fruits (and vegetables) of their labor. This season's harvest was one of our best yet, with a wide variety of fresh, organic produce. All the food was distributed to local families and food banks, helping to combat food insecurity in our neighborhood.</p><p>A huge thank you to all the dedicated gardeners who tended to the plots all season long. Your hard work has made a real difference.</p>"
    },
    {
      image: "https://placehold.co/600x400.png",
      date: "June 1, 2024",
      ...
      content: "<p>Exciting news! BPM has been awarded a significant grant from the Tech for Good Foundation. This funding will be used to launch a new series of free coding workshops for underprivileged youth in our community. The program aims to bridge the digital divide and provide young people with valuable skills for the future job market.</p><p>The curriculum will cover web development, programming basics, and digital design. We are currently recruiting instructors and finalizing the schedule. More information will be available on our website soon.</p>"
    },
];
